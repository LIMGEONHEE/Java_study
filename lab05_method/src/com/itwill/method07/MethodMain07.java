...
public class MethodMain07 {
	...
	public static void main(String[] args) {
		...
		System.out.println(calculate("/")); // 결과: 0
		System.out.println(calculate("+", 4, 6)); // 결과: 10
		System.out.println(calculate("*", 2, 3, 6)); // 결과: 36
		System.out.println(calculate("*")); // 결과: 1
	...
	public static int addAll(int... args) {
		System.out.println("lengt = " + args.length); // 가변길이 인수는 배열처럼 length 속성이 있다.
