...
public class VariableMain01 {
	...
	public static void main(String[] args) {
		...
		int age; // 선언문, 정수(integer)를 저장하는 변수 age 
		age = 16; // 변수 age를 16으로 초기화(변수를 age에 정수 16을 저장)
		...
		//변수 이름 작성 규칙:
		// - 변수 이름은 알파벳, 숫자, 특수기호(_,$)만 사용 가능.
		// - 변수 이름은 대/소문자를 구분한다. (예) X, x는 서로 다른 변수.
		// - 변수 이름은 숫자로 시작할 수 없다.
		// - 변수 이름으로 자바의 키워드(예약어)는 사용할 수 없다.
		// - 변수 이름은 변수 역할에 어울리는 "의미 있는" 단어를 사용해서 만드는 것을 권장.
		// - 변수 이름을 2개 이상의 단어를 붙여서 만들 경우에는 
		// "소문자"로 시작하는 camel 표기법을 권장.(예) useId, userPassword
