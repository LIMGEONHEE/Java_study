...
public class AppMain02 {
	...
	private void initialize() {
		...
		lblMessage.setFont(new Font("D2Coding", Font.BOLD, 26));
		lblMessage.setBounds(12, 10, 410, 80);
		frame.getContentPane().add(lblMessage);
		
		textInput = new JTextField();
		textInput.setFont(new Font("D2Coding", Font.BOLD, 25));
		textInput.setBounds(12, 113, 410, 71);
		...
		btnInput.setFont(new Font("D2Coding ligature", Font.BOLD, 25));
